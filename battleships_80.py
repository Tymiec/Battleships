...
class Battleships():
    ...
    def __init__(self):
        ...
        self.preparation_background = pygame.image.load(
            "Assets/Images/preparation_screen.png")
        ...
        # BUTTON LOADER
        self.play_no_hover = pygame.image.load(
            "Assets/Images/play_no_hover.png").convert_alpha()
        self.play_hover = pygame.image.load(
            "Assets/Images/play_hover.png").convert_alpha()
        self.play_button = button.Button(398, 385, self.play_no_hover,
                                         self.play_hover, 1)

        self.start_no_hover = pygame.image.load(
            "Assets/Images/start_no_hover.png").convert_alpha()
        self.start_hover = pygame.image.load(
            "Assets/Images/start_hover.png").convert_alpha()
        self.start_button = button.Button(369, 680, self.start_no_hover,
                                          self.start_hover, 1)

        self.options_no_hover = pygame.image.load(
            "Assets/Images/options_no_hover.png").convert_alpha()
        self.options_hover = pygame.image.load(
            "Assets/Images/options_hover.png").convert_alpha()
        self.options_button = button.Button(319, 485, self.options_no_hover,
                                            self.options_hover, 1)

        self.credits_no_hover = pygame.image.load(
            "Assets/Images/credits_no_hover.png").convert_alpha()
        self.credits_hover = pygame.image.load(
            "Assets/Images/credits_hover.png").convert_alpha()
        self.credits_button = button.Button(319, 585, self.credits_no_hover,
                                            self.credits_hover, 1)

        self.exit_no_hover = pygame.image.load(
            "Assets/Images/exit_no_hover.png").convert_alpha()
        self.exit_hover = pygame.image.load(
            "Assets/Images/exit_hover.png").convert_alpha()
        self.exit_button = button.Button(408, 825, self.exit_no_hover,
                                         self.exit_hover, 1)

        self.x_back_button = 20
        self.y_back_button = 20
        self.back_no_hover = pygame.image.load(
            "Assets/Images/back_no_hover.png").convert_alpha()
        self.back_hover = pygame.image.load(
            "Assets/Images/back_hover.png").convert_alpha()
        self.back_button = button.Button(self.x_back_button, self.y_back_button,
                                         self.back_no_hover, self.back_hover,
                                         0.4)

        self.generate_no_hover = pygame.image.load(
            "Assets/Images/generate_no_hover.png").convert_alpha()
        self.generate_hover = pygame.image.load(
            "Assets/Images/generate_hover.png").convert_alpha()
        self.generate_button = button.Button(116, 122, self.generate_no_hover,
                                             self.generate_hover, 1)
        # 50 i -136
        # GAME LOADERS
        self.hit_sprite = pygame.image.load(
            "Assets/Images/hit_sprite.png").convert_alpha()
    ...
    def screen_refresh(self):
        ...
        for event in pygame.event.get():
            if event.type == QUIT:
                ...
                self.this_windows = pygame.display.set_mode((1024, 896),
                                                            HWSURFACE | DOUBLEBUF)
        self.this_windows.blit(pygame.transform.scale(self.obraz,
                                                      self.this_windows.get_rect().size),
                               (0, 0))
    ...
    def Intro(self):
        ...
        for i in range(0, 4):
            self.obraz.blit(self.introSprite, Rect(192, 352, 608, 320),
                            Rect(0, i * 320, 608, 320))
            if not self.wait_or_skip(32):
                return
    ...
    def Menu(self):
        ...
        while True:
            ...
            # BUTTONS
            # BUTTON PLAY
            if self.play_button.draw(self.obraz) and pygame.mouse.get_pressed()[
                0] == 1:
                self.obraz.blit(self.preparation_background,
                                self.preparation_background.get_rect())
                self.screen_refresh()
            ...
            # # BUTTON OPTIONS
            if self.options_button.draw(self.obraz) and \
                    pygame.mouse.get_pressed()[0] == 1:
                self.obraz.blit(self.options, self.options.get_rect())
                options_loop = True
                # OPTIONS LOOP
                while options_loop is True:
                    if self.back_button.draw(self.obraz) and \
                            pygame.mouse.get_pressed()[0] == 1:
                        options_loop = False
                    if self.exit_button.draw(self.obraz) and \
                            pygame.mouse.get_pressed()[0] == 1:
            ...
            # # BUTTON CREDITS
            if self.credits_button.draw(self.obraz) and \
                    pygame.mouse.get_pressed()[0] == 1:
            ...
            # # BUTTON EXIT
            if self.exit_button.draw(self.obraz) and pygame.mouse.get_pressed()[
                0] == 1:
                print("Thanks for playing!")
                pygame.quit()
                sys.exit()
    ...
    def Computer_targeting(self):
        ...
        while not_different:  # random generating coordinate until we find a free spot
            ...
            if self.hit_board_1[random_x][random_y] != 1 and \
                    self.hit_board_1[random_x][random_y] != 2 and \
                    self.hit_board_1[random_x][random_y] != 4:
                not_different = False
        # print(f"Add computer shot to: {random_x}, {random_y}")
        if self.hit_board_1[random_x][random_y] not in [1, 2, 4,
                                                        10]:  # sprawdzamy czy nie stawiamy na statku FIXME: chyba zbędny?
            if self.ship_board_1[random_x][random_y] == 3:
                ...
                self.MarkAsOccupiedFromThisField(self.hit_board_1, random_x,
                                                 random_y)
    ...
    def Change_number_to_array(self):
        ...
        while self.computer_shot_counter != 0:
            self.computer_shot_counter, d = divmod(self.computer_shot_counter,
                                                   10)
        ...
        while self.player_succesfull_hit_counter != 0:
            self.player_succesfull_hit_counter, d = divmod(
                self.player_succesfull_hit_counter, 10)
        ...
        while self.computer_succesfull_hit_counter != 0:
            self.computer_succesfull_hit_counter, d = divmod(
                self.computer_succesfull_hit_counter, 10)
        ...
        while not_colliding is False:
            ...
            if direction == 0:
                for i in range(length):
                    if grid[random_x][random_y + i] == 3 or grid[random_x][
                        random_y + i] == 10:
                ...
                for i in range(length):
                    if grid[random_x + i][random_y] == 3 or grid[random_x + i][
                        random_y] == 10:
                        # print("nie miesci sie")
                        return False
                    else:
    ...
    def PreparationLoop(self):
        while self.preparation_loop is True:
            ...
            if self.generate_button.draw(self.obraz) and \
                    pygame.mouse.get_pressed()[
                        0] == 1 and self.generation_counter_2 == 0:  # generate button
            ...
            if self.start_button.draw(self.obraz) and \
                    pygame.mouse.get_pressed()[0] == 1:
                self.game_loop = True
                ...
                self.GameLoop()
            # GAME LOOP END
            if self.back_button.draw(self.obraz) and pygame.mouse.get_pressed()[
                0] == 1:
                self.Clean_boards()
                self.generation_counter = 0
                self.generation_counter_2 = 0
            ...
            for x in range(0, 10):
                for y in range(0, 10):
                    self.obraz.blit(self.hit_sprite,
                                    Rect(x * 38 + 66, y * 38 + 258, 38, 38),
                                    Rect(self.ship_board_1[x][y] * 38, 0, 38,
                                         38))
            ...
            if pygame.mouse.get_pressed()[0] == 1:
                ...
                for x in range(0, 10):
                    for y in range(0, 10):
                        ...
                        if check_pos.collidepoint(mouse_pos_1[0],
                                                  mouse_pos_1[1]) == True and \
                                self.ship_board_1[x][y] != 10 and \
                                self.ship_board_1[x][
                                    y] != 3 and self.place_player_ship_counter < 20:
                            # print(f"Add ship to player board on x: {x}| y: {y}")
                            self.ship_board_1[x][
                                y] = 3  # zmiana kwadratu na statek
                            self.MarkAsOccupiedFromThisField(self.ship_board_1,
                                                             x, y)
        ...
        while self.game_loop is True:
                    ...
                    for x in range(0, 10):
                        for y in range(0, 10):
                            ...
                            if check_pos.collidepoint(mouse_pos_1[0],
                                ...
                                if self.ship_board_2[x][y] == 3 and \
                                        self.hit_board_2[x][y] != 1 and \
                                        self.hit_board_2[x][
                                            y] != 2:  # sprawdzamy czy jest tam statek i czy juz nie strzelalismy
                                    ...
                                    self.player_move = True
                                    self.computer_move = False
                                elif self.ship_board_2[x][y] == 0 and \
                                        self.hit_board_2[x][y] not in (1, 2):
            ...
            for x in range(0, 10):
                for y in range(0, 10):
                    self.obraz.blit(self.hit_sprite,
                                    Rect(x * 38 + 66, y * 38 + 258, 38, 38),
                                    Rect(self.hit_board_1[x][y] * 38, 0, 38,
                                         38))
                    self.obraz.blit(self.hit_sprite,
                                    Rect(x * 38 + 578, y * 38 + 258, 38, 38),
                                    Rect(self.hit_board_2[x][y] * 38, 0, 38,
                                         38))
            self.screen_refresh()
    ...
    def SummaryLoop(self):
        while self.end_screen_loop is True:
            ...
            if self.player_shot_counter_array != []:
                for x in range(2):
                    self.obraz.blit(self.numbers,
                                    Rect(x * 34 + 384, 685, 34, 30),
                                    Rect(self.player_shot_counter_array[x] * 34,
                                         0, 34, 30))
            if self.player_succesfull_hit_counter_array != []:
                for x in range(2):
                    self.obraz.blit(self.numbers,
                                    Rect(x * 34 + 384, 730, 34, 30), Rect(
                            self.player_succesfull_hit_counter_array[x] * 34, 0,
                            34, 30))
            if self.computer_shot_counter_array != []:
                for x in range(2):
                    self.obraz.blit(self.numbers,
                                    Rect(x * 34 + 894, 685, 34, 30), Rect(
                            self.computer_shot_counter_array[x] * 34, 0, 34,
                            30))
            if self.computer_succesfull_hit_counter_array != []:
                for x in range(2):
                    self.obraz.blit(self.numbers,
                                    Rect(x * 34 + 894, 730, 34, 30), Rect(
                            self.computer_succesfull_hit_counter_array[x] * 34,
                            0, 34, 30))
            self.screen_refresh()
